...
public class testAPSSwapWithCondiOnR1 extends TestBase {
...
//				Vertex.valueOf("Y12"), Vertex.valueOf("Y15"), Vertex.valueOf("Y20"),
	...
	public void test() {
		...
		UnderlyingType underylingType1 = UnderlyingType.R1mR2;
		...
		legCouponInfos[0] = new LegStructuredCouponInfo(payRcv1,
				couponType1, underylingType1, conditionType1, 
				payUndInfos,
