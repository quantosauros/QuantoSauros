...
import com.quantosauros.jpl.dto.LegEquityCouponInfo;
...
//				Vertex.valueOf("Y12"), Vertex.valueOf("Y15"), Vertex.valueOf("Y20"),
	...
	public static void main(String[] args) {
		...
		UnderlyingType underlyingType1 = UnderlyingType.R1nEQ;
		ConditionType conditionType1 = ConditionType.R1nR2;
		UnderlyingInfo[] payUndInfos = new UnderlyingInfo[]{
			new RateUnderlyingInfo(
					ModelType.HW1F, 0.25, Frequency.valueOf("Q"), RateType.SPOT),
			new EquityUnderlyingInfo(ModelType.BS, 1000, RiskFreeType.L1U1),
		};
		...
		legCouponInfos[0] = new LegEquityCouponInfo(payRcv1, 
				couponType1, conditionType1, 
				payUndInfos,
				upperLimits, lowerLimits, inCouponRates, outCouponRates, 
				hasCap, cap, hasFloor, floor, 
				leverages1, spreads1, basePrice);
		...
		legUnderlyingInfos[0][1] = new EquityMarketInfo(
				1000, 0.1, 0, _structuredLegCurve1);
